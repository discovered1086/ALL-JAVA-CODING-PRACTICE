...
public class PredicateMethodArgHarness {
	public static void main(String[] args) {
		 ...
		 * IntPredicate which is nothing but Predicate<Integer>.
		 */
		IntPredicate checkDivisibleByTwo = theNumber -> theNumber % 2 == 0;

		/*
		 * Here we're passing the predicate or the rule and the target of that rule to
		 * the method printDivisibleByTwo. This is where we experience the power of
		 * lambda expressions and functional programming. We're able to pass behavior or
		 * a method as part of argument to another method.
		 * 
		 */
		printDivisibleByTwo(checkDivisibleByTwo, divisibleByTwo);
	}

	static void printDivisibleByTwo(IntPredicate predicate, Integer[] theArray) {
