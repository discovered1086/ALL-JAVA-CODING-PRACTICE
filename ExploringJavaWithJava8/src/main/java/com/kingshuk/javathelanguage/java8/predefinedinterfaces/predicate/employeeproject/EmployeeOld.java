...
public class EmployeeOld {
	...
	public static class FactoryMethodCreator {
		...
		public EmployeeOld createEmployee(String employeeName, EmployeeLocation employeeLocation, Designation designation,
			...
			return new EmployeeOld(employeeName, employeeLocation, designation, salary, joiningDate);
