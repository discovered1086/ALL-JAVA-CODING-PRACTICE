...
public class LittleEndianInputStream extends FilterInputStream {
   ...
   * @exception  java.io.EOFException  if the end of the underlying input stream
   *              has been reached
   ...
   *
   * @return     the <code>byte</code> value read.
   * @exception  java.io.EOFException  if the end of the underlying input
   ...
   * @exception  java.io.UTFDataFormatException if the string cannot be decoded
   * @exception  java.io.IOException  if the underlying stream throws an IOException.
   */
   ...
   * @exception  java.io.EOFException if end of stream occurs before eight bytes
   *             have been read.
   ...
   * @exception  java.io.EOFException if end of stream occurs before four bytes
   *             have been read.
   * @exception  java.io.IOException  if an I/O error occurs.
   */
