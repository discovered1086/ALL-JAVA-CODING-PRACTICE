...
public class AccountManager {
    ...
    public void performBankActions(AccountHolder accountHolder, AccountAction accountAction) throws InterruptedException {
        ...
        synchronized (this) {
            if ("debit".equals(accountAction.getActionType())) {
                ...
                if (bankAccount.getAccountBalance() > accountAction.getAmount()) {
                    ...
                    System.out.println("Sorry " + accountHolder.getName() + " !! There's not enough balance for you");
                }
            }
        }
