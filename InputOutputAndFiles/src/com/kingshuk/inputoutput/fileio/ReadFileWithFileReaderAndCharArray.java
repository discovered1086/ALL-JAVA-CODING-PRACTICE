...
public class ReadFileWithFileReaderAndCharArray {
	
	private static final Logger LOGGER = Logger.getLogger(ReadFileWithFileReaderAndCharArray.class.getName());

	public static void main(String[] args) {
		String sourceDirectory = "resources/Assignment Location Change.docx";

		String destinationDirectory = "destinationResource/Assignment Location Change.docx";
		...
		try (FileReader fileReader = new FileReader(source);
			...
			while(bufferedReader.read(charArray)!=-1) {
